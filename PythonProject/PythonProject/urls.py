...
urlpatterns = [
    ...
    url(r'^StationInfo/', include('apps.StationInfo.urls', namespace='StationInfo')),  # 机场信息模块
    url(r'^Flight/', include('apps.Flight.urls', namespace='Flight')),  # 航班信息模块
    url(r'^SeatType/', include('apps.SeatType.urls', namespace='SeatType')),  # 座位席别模块
    url(r'^OrderInfo/', include('apps.OrderInfo.urls', namespace='OrderInfo')),  # 订单信息模块
    url(r'^Recharge/', include('apps.Recharge.urls', namespace='Recharge')),  # 充值信息模块
